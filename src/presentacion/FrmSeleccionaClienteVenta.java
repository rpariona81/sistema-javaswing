 ...
 * @author JRonald
 */
public class FrmSeleccionaClienteVenta extends javax.swing.JDialog {
     ...
     */
    public FrmSeleccionaClienteVenta(java.awt.Frame parent, FrmVenta frm, boolean modal) {
        super(parent, modal);
        initComponents();
        this.setTitle("Seleccionar un cliente para la venta");
    ...
    private void initComponents() {
        ...
        layout.setHorizontalGroup(
            ...
            .addComponent(tabGeneral, javax.swing.GroupLayout.PREFERRED_SIZE, 707, Short.MAX_VALUE)
        );
    ...
    private void btnSeleccionarClienteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSeleccionarClienteActionPerformed
        if (tablaListado.getSelectedRowCount() == 1) {
            String id = String.valueOf(tablaListado.getValueAt(tablaListado.getSelectedRow(), 0));
            String nombre = String.valueOf(tablaListado.getValueAt(tablaListado.getSelectedRow(), 2));
            if (JOptionPane.showConfirmDialog(this, "¿Deseas seleccionar el registro: " + nombre + "?", "Seleccionar", JOptionPane.YES_NO_OPTION) == 0) {
